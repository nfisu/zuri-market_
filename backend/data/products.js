...
// Product images are direct Unsplash photo URLs for topical accuracy.

const products = [
  // Jewellery
  { id: "jwl-001", name: "Brass Cuff, Hand-Hammered", category: "jewellery", price: 4800, rating: 4.8, reviews: 142, stock: 23, image: "https://images.unsplash.com/premium_photo-1739548337530-8ce124913b2f?w=600&h=600&fit=crop", featured: true, artisan: "Adaeze Okeke, Lagos" },
  ...
  { id: "jwl-004", name: "Bone & Brass Pendant Necklace", category: "jewellery", price: 6200, rating: 4.7, reviews: 34, stock: 12, image: "https://images.unsplash.com/premium_photo-1681276169450-4504a2442173?w=600&h=600&fit=crop", featured: false, artisan: "Kwame Mensah, Accra" },

  // Ankara fashion
  { id: "fsh-001", name: "Ankara Headwrap, Sunset Print", category: "fashion", price: 2800, rating: 4.7, reviews: 203, stock: 56, image: "https://images.unsplash.com/premium_photo-1769339044708-1ec1867cd9cf?w=600&h=600&fit=crop", featured: true, artisan: "Studio Kente, Lagos" },
  ...
  { id: "fsh-003", name: "Wrap Dress, Adire Resist-Dye", category: "fashion", price: 9200, rating: 4.9, reviews: 47, stock: 8, image: "https://images.unsplash.com/premium_photo-1769339044668-94a0ee9e709b?w=600&h=600&fit=crop", featured: false, artisan: "Aṣọ Atelier, Abeokuta" },
  ...
  { id: "hme-004", name: "Soapstone Candle Holder Set", category: "homeware", price: 2900, rating: 4.5, reviews: 73, stock: 44, image: "https://images.unsplash.com/premium_photo-1723645278449-c807b418fd2a?w=600&h=600&fit=crop", featured: false, artisan: "Kisii Stoneworks, Kenya" }
];
